<?php
class Ccc_Order_Block_Adminhtml_Order_Quote_Customer_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        return $this->getUrl('*/*/start', array('customer_id' => $row->getId()));
    }
